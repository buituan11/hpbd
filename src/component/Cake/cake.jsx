          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="hint">
                  <p>
                    Muốn mở quả thì phải làm bánh. Muốn làm bánh thì phải đi
                    loot đồ
                  </p>
                  <p>
                    Tìm trong Menu, Profile, Cake để lấy màu, lấy bánh, lấy nến
                    nha :3
                  </p>
                  <p>Ví dụ như này này</p>
                  <div className="example container-fluid">
                    <div className="row">
                      <div
                        className="col-xl-12 col-12 row"
                        style={{ marginBottom: '8px' }}
                      >
                        <button
                          className="col-xl-2 col-2 button-color-eg"
                          style={{ backgroundColor: '#672907' }}
                          onClick={() => this.pushColor('#672907')}
                        ></button>
                        <p className="col-xl-10 col-10">
                          Ví dụ đây là màu socola. Bấm vào thì nó sẽ hiện màu ở
                          Color nhaa. Bấm thử xemm
                        </p>
                      </div>
                      <div className="col-xl-12 col-12 row">
                        <div
                          className="col-xl-3 col-3 stuff-eg"
                          style={{
                            borderTopLeftRadius: '12px',
                            borderTopRightRadius: '12px',
                          }}
                        ></div>
                        <p className="col-xl-9 col-9">
                          Đây là tầng bánh. Bấm vào thì nó sẽ hiện bánh ở Stuff
                          nhaa. Tầng bánh cũng tìm mọi nơi nhá
                        </p>
                      </div>
                      <p className="col-xl-12 col-12">
                        Tìm màu, tìm nến, tìm bánh ở khắp nơi nha :>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          if (typeof item === 'object') {
            ...
            return (
              <div key={key} id="a-1">
                <div
                  id="a-2"
                  style={{ backgroundColor: this.state.cake[key + 1] }}
                ></div>
              </div>
            );
    ...
    if (cake.length === 0) {
      ...
      if (typeof cake[cake.length - 1] === 'object') {
        if (e === 'candle') {
          ...
          let index = stuff.indexOf('candle');
          stuff.splice(index, 1);
        } else alert('Cắm nến rồi thì sao để bánh lên được?? :D ??');
      } else {
        if (e === 'candle') {
          cake.push([1]);
          let index = stuff.indexOf('candle');
        ...
        >
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>Làm như này để mở khóa nha :></p>
                <p>Làm xong ấn lại mở khóa là được</p>
                <img
                  src="https://res.cloudinary.com/buituan/image/upload/v1571046101/Hpbd/done.jpg"
                  alt=""
                />
              </div>
              <div className="modal-footer">
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <img
                  src="https://res.cloudinary.com/buituan/image/upload/v1572585839/Hpbd/zz.jpg"
                  alt=""
                />
              </div>
              <div className="modal-footer">
    ...
    return (
      <div className="cake">
        <div
          ...
          onClick={() => this.pushStuff('candle', 3)}
        >
          <img src={candle} alt="" />
          <div></div>
        </div>
        ...
        <div className="make container-fluid">
          <div className="row">
            ...
            <div className="col-xl-4 container-fluid btn-cake">
              <div className="row">
                <button
                  className="btn btn-danger col-xl-6 col-6"
                  onClick={() => this.remake()}
                >
