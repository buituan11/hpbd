                  ...
                  <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <div className="hint">
                            <p>Muốn mở quả thì phải làm bánh. Muốn làm bánh thì phải đi loot đồ</p>
                            <p>Tìm trong Menu, Profile, Cake để lấy màu, lấy bánh, lấy nến nha :3</p>
                            ...
                            <div className="example container-fluid">
                                <div className="row">
                                    <div className="col-xl-12 col-12 row">
                                        ...
                                        <p className="col-xl-10 col-10">Ví dụ đây là màu socola. Bấm vào thì nó sẽ hiện màu ở Color nhaa. Bấm thử xemm</p>
                                    </div>
                                    <div className="col-xl-12 col-12 row">
                                        <div className="col-xl-3 col-3 stuff-eg"></div>
                                        <p className="col-xl-9 col-9">Đây là tầng bánh. Bấm vào thì nó sẽ hiện bánh ở Stuff nhaa. Tầng bánh cũng tìm mọi nơi nhá</p>
                                    </div>
                ...
                <div className="modal fade" id="accept" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div className="modal-dialog" role="document">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                            <p>Chúc mừng sinh nhật em :></p>
                            <p>Tặng nè đây là quà của anh</p>
                            <img src="https://res.cloudinary.com/buituan/image/upload/v1572585839/Hpbd/zz.jpg" alt=""/>
                      </div>
                      <div className="modal-footer">
                        <button type="button" className="btn btn-secondary" data-dismiss="modal">Close</button>
                      </div>
